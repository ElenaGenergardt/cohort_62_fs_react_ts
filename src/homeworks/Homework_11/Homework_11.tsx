...
import {Card,Container,ErrorText,PageWrapper,SearchContainer,UniversitiesGrid,
  UniversityCard,UniversityDetail,UniversityName,Text,UniversityLink } from "./styles";
  ...
  const renderUniversityCards = () => {
    return universities.map((university)=> (
      <UniversityCard key= {v4()}>
          ...
          <UniversityDetail>
            <UniversityLink href={university.web_pages[0]}>{university.web_pages[0]} </UniversityLink>
          </UniversityDetail>
        </UniversityCard>
    ) ) };
   return (
