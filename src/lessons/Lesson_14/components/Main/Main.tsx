...
// ШАГ 2: Создаем контекст - глобальное хранилище данных, которые мы хотим передать в любой компонент,
// котрый находится уровнем ниже(глубже) чем компонент Main
...
function Main() {
  ...
  return (
    // ШАГ 3: Обернуть все что у нас в return с помощью MainContext.Provider
    // и передать то что мы хотим в пропсу value
