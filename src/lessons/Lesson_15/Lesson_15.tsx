...
// 4. При клике на ссылку "Create Employee", должна появляться в Main части страница "Create Employee", 
// а при клике на "Employees", должна появляться в Main части страница "Employees"
// 5. Страница "Create Employee" должна включать в себя "Create Employee" форму
// 6. Элементы управления формой "Create Employee":
// #### "Name\*":
// - компонент Input;// - обязательное поле;
// - тип данных: string;
...
//   #### "Job Position":
// - компонент Input;// - опциональное поле;
